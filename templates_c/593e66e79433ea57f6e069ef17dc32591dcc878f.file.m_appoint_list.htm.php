<?php /* Smarty version Smarty-3.1.11, created on 2013-06-22 11:36:34
         compiled from "C:\xampp\htdocs\hmvc\templates\m_appoint_list.htm" */ ?>
<?php /*%%SmartyHeaderCode:314251c566ea7eb6d3-06785354%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '593e66e79433ea57f6e069ef17dc32591dcc878f' => 
    array (
      0 => 'C:\\xampp\\htdocs\\hmvc\\templates\\m_appoint_list.htm',
      1 => 1371893709,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '314251c566ea7eb6d3-06785354',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.11',
  'unifunc' => 'content_51c566ea8833a3_56531040',
  'variables' => 
  array (
    'static_url' => 0,
    'appoint_lst' => 0,
...
<?php if ($_valid && !is_callable('content_51c566ea8833a3_56531040')) {function content_51c566ea8833a3_56531040($_smarty_tpl) {?>
<!doctype html>
<html lang="en">
...
/index.php/m_login/logout/">Logout</a></li>
        ...
        <article class="module width_full">
            <header>
                <h3 class="tabs_involved">Manage Appointments</h3>
                <ul class="tabs">
                    <li><a href="#tab1">Appointments</a></li>
		</ul>
            </header>
 ...
 $_from = $_smarty_tpl->tpl_vars['appoint_lst']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?> 
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $_smarty_tpl->tpl_vars['value']->value['apt_date'];?>
</td>
                                            <td><?php echo $_smarty_tpl->tpl_vars['value']->value['apt_user_last_name'];?>
&nbsp;<?php echo $_smarty_tpl->tpl_vars['value']->value['apt_user_first_name'];?>
</td>
                                            <td><?php echo $_smarty_tpl->tpl_vars['value']->value['apt_content'];?>
</td>
                                            <td><?php if ($_smarty_tpl->tpl_vars['value']->value['apt_state']=='1'){?>accept<?php }elseif($_smarty_tpl->tpl_vars['value']->value['apt_state']=='2'){?>decline<?php }elseif($_smarty_tpl->tpl_vars['value']->value['apt_state']=='3'){?>postpone<?php }else{ ?>----------<?php }?></td>
                                             <td>
                                                <a href='<?php echo $_smarty_tpl->tpl_vars['static_url']->value;?>
/index.php/m_appoint/edit/f56238787682<?php echo $_smarty_tpl->tpl_vars['value']->value['apt_id'];?>
65582as0f9as9fw90sa345' class='edit'><input type='image'src='<?php echo $_smarty_tpl->tpl_vars['static_url']->value;?>
/static/images/admin/icn_edit_article.png' title='Edit'></a>
                                                <a href='<?php echo $_smarty_tpl->tpl_vars['static_url']->value;?>
/index.php/m_appoint/delete/7fa8sf9as623648<?php echo $_smarty_tpl->tpl_vars['value']->value['apt_id'];?>
9879sa7df907sf6s8f' class='delete'><input type='image'src='<?php echo $_smarty_tpl->tpl_vars['static_url']->value;?>
/static/images/admin/icn_trash.png' title='Trash'></a>
    ...
    <?php echo $_smarty_tpl->tpl_vars['appoint_page']->value;?>
