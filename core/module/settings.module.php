...
class SettingsModule
{
	...
	public function savePersonal()
	{
		...
		$user = array(
			...
			'birth'        => trim($_FANWE['request']['birth']),
			'carrier'        => trim($_FANWE['request']['carrier']),
			'length'        => trim($_FANWE['request']['length']),
			'weight'        => trim($_FANWE['request']['weight']),
			'xiong'        => trim($_FANWE['request']['xiong']),
			'yao'        => trim($_FANWE['request']['yao']),
			'tun'        => trim($_FANWE['request']['tun']),
			'fuzhi'        => trim($_FANWE['request']['fuzhi']),
			'fazhi'        => trim($_FANWE['request']['fazhi']),
			'xiema'        => trim($_FANWE['request']['xiema']),
		);
