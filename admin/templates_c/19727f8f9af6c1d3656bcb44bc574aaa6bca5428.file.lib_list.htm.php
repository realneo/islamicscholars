<?php /* Smarty version Smarty-3.1.11, created on 2013-12-22 13:41:26
         compiled from "/Users/Administrator/Sites/islamicscholars/admin/templates/lib_list.htm" */ ?>
<?php /*%%SmartyHeaderCode:5519580775208abf7377916-83998065%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '19727f8f9af6c1d3656bcb44bc574aaa6bca5428' => 
    array (
      0 => '/Users/Administrator/Sites/islamicscholars/admin/templates/lib_list.htm',
      1 => 1387715782,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5519580775208abf7377916-83998065',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.11',
  'unifunc' => 'content_5208abf74230a1_88684040',
  'variables' => 
  array (
    'static_url' => 0,
    'lib_lst' => 0,
...
<?php if ($_valid && !is_callable('content_5208abf74230a1_88684040')) {function content_5208abf74230a1_88684040($_smarty_tpl) {?>
<!doctype html>
<html lang="en">
...
/index.php/m_event/index/1">Website Admin</a> 
                ...
                <a class="current">View Libraries</a>
            </article>
        </div>
...
/index.php/m_login/logout/">Logout</a></li>
        ...
        <article class="module width_full">
            <header>
                <h3 class="tabs_involved">Manage Libraries</h3>
                <ul class="tabs">
                    <li><a href="#tab1">Libraries</a></li>
		</ul>
            </header>
 ...
 $_from = $_smarty_tpl->tpl_vars['lib_lst']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?> 
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $_smarty_tpl->tpl_vars['value']->value['lib_date'];?>
</td>
                                            <td><?php echo $_smarty_tpl->tpl_vars['value']->value['lib_title'];?>
</td>
                                             <td>
                                                <a href='<?php echo $_smarty_tpl->tpl_vars['static_url']->value;?>
/index.php/m_lib/edit/as98d7f9a8s7879<?php echo $_smarty_tpl->tpl_vars['value']->value['lib_id'];?>
98a7sd9f8' class='edit'><input type='image'src='<?php echo $_smarty_tpl->tpl_vars['static_url']->value;?>
/static/images/admin/icn_edit_article.png' title='Edit'></a>
                                                <a href='<?php echo $_smarty_tpl->tpl_vars['static_url']->value;?>
/index.php/m_lib/delete/9a7sd9f87998<?php echo $_smarty_tpl->tpl_vars['value']->value['lib_id'];?>
7687sa9d8f7' class='delete'><input type='image'src='<?php echo $_smarty_tpl->tpl_vars['static_url']->value;?>
/static/images/admin/icn_trash.png' title='Trash'></a>
    ...
    <?php echo $_smarty_tpl->tpl_vars['lib_page']->value;?>
