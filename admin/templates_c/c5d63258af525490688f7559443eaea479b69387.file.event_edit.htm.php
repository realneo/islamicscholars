<?php /* Smarty version Smarty-3.1.11, created on 2013-12-23 09:12:04
         compiled from "/Users/Administrator/Sites/islamicscholars/admin/templates/event_edit.htm" */ ?>
<?php /*%%SmartyHeaderCode:137847451652b7f011b7b748-76354418%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c5d63258af525490688f7559443eaea479b69387' => 
    array (
      0 => '/Users/Administrator/Sites/islamicscholars/admin/templates/event_edit.htm',
      1 => 1387786316,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '137847451652b7f011b7b748-76354418',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.11',
  'unifunc' => 'content_52b7f011c1b305_07111257',
  'variables' => 
  array (
    'static_url' => 0,
    'param' => 0,
...
<?php if ($_valid && !is_callable('content_52b7f011c1b305_07111257')) {function content_52b7f011c1b305_07111257($_smarty_tpl) {?>
<!doctype html>
<html lang="en">
...
/index.php/m_event/edit/<?php echo $_smarty_tpl->tpl_vars['param']->value;?>
" enctype="multipart/form-data">
        <article class="module width_full">
            ...
            <fieldset>
                <label>Title</label>
                <input type="text" name ="name" id="name" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['evt_name'];?>
" />
            </fieldset>
            <fieldset>
                <label>Venue</label>
                <input type="text" name ="venue" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['evt_venue'];?>
" />
            </fieldset>
            <fieldset>
                <label>Date</label>
...
" id="datepicker" onclick="javascript:NewCssCal('datepicker','YYYYMMDD')"/>
            ...
            <fieldset>
                ...
                <textarea name ="description"><?php echo $_smarty_tpl->tpl_vars['data']->value['evt_desc'];?>
</textarea>
            </fieldset>  
            <fieldset>
                <label>Image</label>
