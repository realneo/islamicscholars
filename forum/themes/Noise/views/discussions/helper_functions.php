...
<li class="<?php echo $CssClass; ?>">
   ...
   <div class="ItemContent Discussion">
      ...
      <div class="Meta">
         ...
         <?php } ?>
         <span class="CommentCount"><?php printf(Plural($Discussion->CountComments, ' %s<span class="commentbubble"></span>', ' %s<span class="commentsbubble"></span>'), $Discussion->CountComments); ?></span>
         <?php
            ...
            $Sender->FireEvent('AfterCountMeta');
             // Avatars in discussions inpired in GO theme by 422: http://vanillaskins.com/, adapted by sevmc22: www.makeitsound.org
            if ($Discussion->LastCommentID != '') {
               echo '<span><div class="reply-arrow">&nbsp;</div><span class="reply-avatar">'.UserPhoto($Last).'</span>'.'</span>';
               echo '<span>'.Gdn_Format::Date($Discussion->LastDate).'</span>';
			    echo '<span><span class="author-avatar">'.UserPhoto($First).'</span>'.'</span>';
            } else {
               echo '<span><div class="author-arrow">&nbsp;</div><span class="author-avatar">'.UserPhoto($First).'</span>'.'</span>';
               echo '<span>'.Gdn_Format::Date($Discussion->FirstDate);
