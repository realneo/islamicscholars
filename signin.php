...
<div class='row'>
    ...
    <div class='span4'>
        ...
        <div class='msg_body'>
            <div id='login_msg'></div><!-- login_msg -->
            ...
            <form name='register_form' action='includes/login_process.php' method='post'>
                <h2>Login</h2>
                <input type='email' class='input-medium' placeholder='Email' name='email' id='email'>
                <input type='password' class='input-medium' placeholder='Password' name='password' id='password'><br>
                                    <a href="forgetpassword.php" style="color:blue;">Forgot Password ?</a>
                <input type="submit" value="Sign In" class="btn btn-success pull-right" id='signin_btn'>
                    <?php	
