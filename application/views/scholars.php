<div class="span9">
    <div class="title_bar_white span9">Imams / Scholars / Sheikhs</div>
        ...
        <div class="opacity-5 span9 file-hover ">
            <div class="span1 padding-all-5"><?php echo img("assets/img/scholars/$scholar->sclar_img"); ?></div>
                <div class="span7 white">
                    <div class="heading2 padding-all-5 "><?php echo $scholar->sclar_name; ?></div>
