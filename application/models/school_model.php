...
class school_model extends CI_Model {
	...
	public function  insert($scholar,$school){
		$data =array('schl_name'=>$school,
					'schl_scholar_id'=>$scholar,
					'schl_regdate'=>date("Y-m-d H:i:s"));
	...
	{
		$sql="SELECT * FROM h_schooltb WHERE schl_scholar_id='".$id."'";
    ...
    {
		return $this->db->delete('schooltb', array('schl_scholar_id'=>$edit_id)); 
    }
